...
|-----------|------|
| **Ретранслятор** — Все устройство в сборе. Конструкцию делал просторную для удобства ревизии и настройки, 
так что поместил все в короба из OSB, плюс это дополнительная защита от осадков и солнца.| <img src="docs/photos/front_view.png" width="200"/> |
