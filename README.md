...
| **Блок управления** — контроллер на ESP8266 + LoRa | <img src="docs/photos/station.jpg" width="200"/> <img src="docs/photos/station_open.jpg" width="200"/> |
...
3. **Блок управления** — контроллер на ESP8266 + LoRa.
   <p align="center">
  <a href="docs/photos/station.jpg">
    <img src="docs/photos/station.jpg" width="200" />
  </a>
</p>
    
5. **Поворотная платформа** — управляемые сервоприводы + камера.  
6. **Пульт оператора** — с дисплеем и управлением режимами.
7. **БПЛА** — FPV борт со своуй камерой
