...
## 👣 Переключение камер
Оператор вначалеле на своем мониторе видит картинку с камеры, установленной на поворотной платформе ретранслятора. Затем нажимает кнопку на пульте управления и картинка переключается на камеру дрона. 
<p align="center">
  <a href="docs/photos/camera.png">
    <img src="docs/photos/camera.png" width="400" />
  </a>
</p>
