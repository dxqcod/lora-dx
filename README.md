...
| **Пульт оператора** <br> - По середине потенциометр с помощь которого выставляется угол поворота антенн. <br> - Дисплей, на котором отображается: <br> - угол поворота антенны <br> - включчен или выключен ретранслятор <br> - температура блока управления <br> - источник видеосигнала: дрон или камера на поворотной платформе  | <img src="docs/photos/remote_control.png" width="200"/> |
