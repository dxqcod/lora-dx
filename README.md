...
## 👣 Переключение камер
Оператор вначалеле на своем мониторе видит картинку с камеры, установленной на поворотной платформе ретранслятора. Затем, когда он выбрал направление, в котором будет лететь, нажимает кнопку на пульте управления и картинка переключается на камеру дрона. 
<p align="center">
  <a href="docs/photos/camera.png">
    <img src="docs/photos/camera.png" width="600" />
  </a>
</p>
